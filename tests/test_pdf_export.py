...
class TestPdfExport:
    ...
    def test_engine_suffix_generation(self):
        ...
        self.config_manager.get.side_effect = lambda k, d=None: "pdf" if k == "output_format" else d
    ...
    def test_office_converter_pdf(self, mock_exists, mock_move, mock_soffice_path, mock_subprocess):
    ...
    @patch('pathlib.Path.exists')
    def test_ppt_converter_pdf(self, mock_exists, mock_glob, mock_move, mock_soffice_path_ppt, mock_subprocess):
