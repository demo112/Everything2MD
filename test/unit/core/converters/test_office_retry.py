...
def test_copy_retry_success(mock_sleep, mock_copy, mock_run, mock_pandoc, mock_soffice, converter, tmp_path):
...
@patch("shutil.copy")
@patch("time.sleep")
def test_copy_retry_failure(mock_sleep, mock_copy, mock_pandoc, mock_soffice, converter, tmp_path):
